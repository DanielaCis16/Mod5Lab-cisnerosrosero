...
// Create a new player with one life and add points
// to the player's score
Player player = new Player("Frankenstein", 1);
player.AddPoints(100);

//Dislplay the player's score
...
Console.WriteLine("An orc attaks you. Sorry, you were killed. You have " +
player.GetLivesLeft() + " lives left!");

//Create a super pplayer
SuperPlayer superPlayer = new SuperPlayer();
superPlayer.AddPoints(200);
superPlayer.Fly(); // demonstrate his additional ability
Console.WriteLine($"SuperPlayer's score: {superPlayer.GetScore()}, lives left: {superPlayer.GetLivesLeft()}");