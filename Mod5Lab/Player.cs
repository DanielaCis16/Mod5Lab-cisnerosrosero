...
namespace Module5Lab
{
    internal class Player
    {
        ...
        // Three constructors
        //First constructor creeates a player object
        ...
        {
            // Set the name attribute and the lives left attribute
            // to the values that were passed to the constructor method
            this.name = name;
            livesLeft = startingLives;
        } // end constructor

        //Methods -these are tasks or actions
        // that our object can perform
